...
class Widget():
    ...
    greet = ['Hey Whats up! How are you doing', 'Hello Rimsha','Hi ! I am your Assistant','Hello, How can I help You']
    ...
    creator = ['You made Me','I was Made by Rimsha','One And only, Rimsha','Best in the World, Rimsha']
    ...
    me = ['You Told Me Your Name, Rimsha','I Think That\'s Rimsha','Your Name That I Know Is Rimsha']
